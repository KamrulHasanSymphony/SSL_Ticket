...
namespace SSL.Ticket.SSL.Ticket.Repository.SqlServer.EnternalNote
{
    public class EnternalNoteRepository : Repository, IEnternalNoteRepository
    {
        private CS.SSL.Common.Models.DbConfig _dbConfig;
        public EnternalNoteRepository(SqlConnection context, SqlTransaction transaction, CS.SSL.Common.Models.DbConfig dbConfig)
        {
        ...
        public List<T_TaskInternalNotesVM> GetAll(string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            throw new NotImplementedException();
        }

        public List<T_TaskInternalNotesVM> GetIndexData(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            throw new NotImplementedException();
        }
        ...
        public T_TaskInternalNotesVM Insert(T_TaskInternalNotesVM model)
        {
            string sqlText = "";
            int Id = 0;
            int transResult = 0;
            ...
            {
                sqlText = "";
                sqlText = @" INSERT INTO T_TaskInternalNotes(
                                     T_TaskId
                                    ,ShortNote
                                    ,Description
                                    ,AssigneeUserId
        ...
        public T_TaskInternalNotesVM InsertActive(T_TaskInternalNotesVM model)
        {
            ...
            try
            {
                ...
                int count = 0;
                sqlText = "";
                sqlText = @" Update T_TaskInternalNotes set
                                    IsActive = @IsActive
                                    Where Id = @Id "
                ;
        ...
        public T_TaskInternalNotesVM Update(T_TaskInternalNotesVM model)
        {
            throw new NotImplementedException();
        }
    }
