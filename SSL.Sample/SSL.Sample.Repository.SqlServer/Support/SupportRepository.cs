...
using SSL.Sample.Core.ExtentionMethod;
...
namespace SSL.Sample.SSL.Sample.Repository.SqlServer.Support
{
    public class SupportRepository : Repository, ISupportRepository
    {
        private SSL.Sample.Models.DbConfig _dbConfig;
        public SupportRepository(SqlConnection context, SqlTransaction transaction, SSL.Sample.Models.DbConfig dbConfig)
        {
