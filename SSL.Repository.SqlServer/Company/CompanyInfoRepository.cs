...
namespace SSL.Repository.SqlServer.Company
{
...
SELECT DISTINCT bp.[BranchID]
      ...
      ,ISNULL(bp.[CompanyCode],'0') CompanyCode
      ,ISNULL(bp.[BIN],'') BIN
      ,ISNULL(bp.[SageBranchCode],'') SageBranchCode
      ,ISNULL(bp.[DLRCreditCOA],'') DLRCreditCOA
