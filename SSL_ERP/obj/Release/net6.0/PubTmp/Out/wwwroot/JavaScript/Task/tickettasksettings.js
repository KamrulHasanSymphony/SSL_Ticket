...
var TaskSummaryHelper = {
        ...
        $("#kTaskGrid").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: true,
                    width: 200,
                    template: '#= kendo.toString(kendo.parseDate(startTime), "HH:mm") #',
                    filterable: {
                        ui: function (element) {
                ...
                {
                    field: "productName", title: "Product", sortable: true, width: 200
                },
                {
                    field: "departmentName", title: "Department", sortable: true, width: 200
                },
                {
    ...
    GenerateOpenTaskGrid: function () {

        var ticketId = $("#T_TicketId").val();
        var AssigneeUserId = $("#AssigneeUserId").val();

        $("#kOpenTaskGrid").kendoGrid({
            dataSource: TaskSummaryManager.gridOpenDataSource(ticketId, AssigneeUserId),
            pageable: {
                refresh: true,
                serverPaging: true,
                serverFiltering: true,
            ...
            columns: [
                ...
                {
                    field: "description", title: "Description", hidden: true, sortable: true, width: 220
                },
    ...
    GenerateTodayTaskGrid: function () {

        var ticketId = $("#T_TicketId").val();
        var AssigneeUserId = $("#AssigneeUserId").val();

        $("#kTodayTaskGrid").kendoGrid({
            dataSource: TaskSummaryManager.gridTodayDataSource(ticketId, AssigneeUserId),
            pageable: {
                refresh: true,
                serverPaging: true,
                serverFiltering: true,
    ...
    GeneratePendingTaskGrid: function () {

        var ticketId = $("#T_TicketId").val();
        var AssigneeUserId = $("#AssigneeUserId").val();
        $("#kPendingTaskGrid").kendoGrid({
            dataSource: TaskSummaryManager.gridPendingDataSource(ticketId, AssigneeUserId),
            pageable: {
                refresh: true,
                serverPaging: true,
                serverFiltering: true,
    ...
    ClickEvents: function () {
        ...
        $("#btnSaveAssigne").click(function () {
            TaskSummaryManager.SaveAssigne();
            $("#divAssigneModal").data("kendoWindow").close();        
        ...
        $("#btnTimeStart").click(function () {
            TaskSummaryManager.IsStackHolder(selectedId.startedBy, function (data) {
                debugger;
                if (data === true) {
