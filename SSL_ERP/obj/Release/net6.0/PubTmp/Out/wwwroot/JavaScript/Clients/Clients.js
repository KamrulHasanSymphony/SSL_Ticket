        ...
        columns: [
            ...
            // },
            {
                ...
                template: function (dataItem) {
                    return "<a href='/Clients/Edit/" + dataItem.id + "' class='btn btn-primary btn-sm mr-2 edit'>" +
            ...
            {
                field: "address", title: "Address", sortable: true, hidden: true, width: 150
            },
            {
                field: "city", title: "City", sortable: true, hidden: true, width: 200
            },
            {
                field: "district", title: "District", sortable: true, hidden: true, width: 200
            },
            {
                field: "companyContactNumber", title: "CompanyContactNumber", sortable: true, hidden: true, width: 200
            },
            {
                field: "companyEmail", title: "CompanyEmail", sortable: true, hidden: true, width: 200
            },
            {
                field: "website", title: "Website", sortable: true, hidden: true, width: 200
            },
            {
                field: "concernPerson", title: "Concern Person", sortable: true, width: 200
            },
            {
                field: "contactPersonNumber", title: "Person Number", sortable: true, width: 200
            },
            {
                field: "contactPersonEmail", title: "Email", sortable: true, width: 200
            },
            {
