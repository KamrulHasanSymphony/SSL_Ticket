...
namespace SSL.Common.SSL.Common.Models.KendoCommon
{
    ...
    {
        public string constring = ConfigurationManager.ConnectionStrings["Persist Security Info=False;User ID=sa;password=S123456_;Data Source=192.168.15.100\\MSSQLSERVER,1417;Initial Catalog=EAIL2012_Demo_DB;Integrated Security=True;Connection Timeout=100000;MultipleActiveResultSets=True"].ToString();
