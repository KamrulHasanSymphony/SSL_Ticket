...
namespace SSL.CS.SSL.Common.Repository.SqlServer.CompanyInfos
{
    public class CompanyInfosRepository : Repository, ICompanyinfosRepository
    {
        private DbConfig _dbConfig;

        public CompanyInfosRepository(SqlConnection context, SqlTransaction transaction, DbConfig dbConfig)
        {
